...
<body class="sub-body">
    ...
    <!-- Ranking Nacional sin inicio de sesión no muestra los rankings sino el mensaje de aviso que debe iniciar sesión,
    ese mensaje se encuentra en la Funcion $mensajePre en la carpeta Funciones/Archivo Funciones en la linea de Codigo 99.-->
