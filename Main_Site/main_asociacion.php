...
<div id="wrapper">
        ...
        <div id="main-group" class="container-fluid">
            <div class="row main-boton-ban">
            ...
            <div class="descrip-desig collapse" id="mis-tar" data-parent="#main-group">
				<div class="box-des">
					<div class="left-des">
            ...
            <div class="descrip-desig collapse" id="vis-tar" data-parent="#main-group">
				<div class="box-des">		
                        <div class="left-des">
                ...
                <div class="sld-desig collapse" id="jun-tar" data-parent="#main-group">
			...
			<div class="descrip-desig collapse" id="est-tar" data-parent="#main-group">
				<div class="box-des">
					<div class="left-des">
